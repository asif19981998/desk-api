...
namespace Desk.Api.Controllers
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
                var results = await _clientService.GetPagedListAsync(page, pageSize);
                return Ok(new ResponseResult { Result = results, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("Delete")]
        public async Task<IActionResult> SoftDelete(Client client)
        {
            try
            {
                var result = await _clientService.SoftDeleteAsync(client);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDelete(Client client)
        {
            try
            {
                var result = await _clientService.PermanentDeleteAsync(client);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDeleteById(long id)
        {
            try
            {
                var result = await _clientService.PermanentDeleteByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Deleted()
        {
            try
            {
                var results = await _clientService.GetAllDeletedAsync();
                return Ok(new ResponseResult { Result = results, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeletedPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
                var results = await _clientService.GetDeletedPagedAsync(page, pageSize);
                return Ok(new ResponseResult { Result = results, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("Restore")]
        public async Task<IActionResult> Restore(Client client)
        {
            try
            {
                var result = await _clientService.RestoreAsync(client);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreById(long id)
        {
            try
            {
                var result = await _clientService.RestoreByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreByIds(List<long> ids)
        {
            try
            {
                var result = await _clientService.RestoreByIdsAsync(ids);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
