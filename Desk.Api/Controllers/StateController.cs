    ...
    public class StateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                return Ok(new ResponseResult { Result = states, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
                var results = await _stateService.GetPagedListAsync(page, pageSize);
        ...
        public async Task<IActionResult> GetDetails(int id)
        {
            try
            {
                ...
                return Ok(new ResponseResult { Result = state, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
                return Ok(new ResponseResult { Result = null, IsSuccess = false, Message = ex.Message });
        ...
        [HttpPost]
        [Route("Delete")]
        public async Task<IActionResult> SoftDelete(State state)
        {
            try
            {
                var result = await _stateService.SoftDeleteAsync(state);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> SoftDeleteById(long id)
        {
            try
            {
                var result = await _stateService.SoftDeleteByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDelete(State state)
        {
            try
            {
                var result = await _stateService.PermanentDeleteAsync(state);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDeleteById(long id)
        {
            try
            {
                var result = await _stateService.PermanentDeleteByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Deleted()
        {
            try
            {
                var states = await _stateService.GetAllDeletedAsync();
                return Ok(new ResponseResult { Result = states, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeletedPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
                var results = await _stateService.GetDeletedPagedAsync(page, pageSize);
                return Ok(new ResponseResult { Result = results, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("Restore")]
        public async Task<IActionResult> Restore(State state)
        {
            try
            {
                var result = await _stateService.RestoreAsync(state);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreById(long id)
        {
            try
            {
                var result = await _stateService.RestoreByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreByIds(List<long> ids)
        {
            try
            {
                var result = await _stateService.RestoreByIdsAsync(ids);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
