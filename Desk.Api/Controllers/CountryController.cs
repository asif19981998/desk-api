...
namespace Desk.Api.Controllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var countries = await _countryService.GetAllDataAsync();
        ...
        public async Task<IActionResult> GetPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
               var results = await _countryService.GetPagedListAsync(page, pageSize);
        ...
        public async Task<IActionResult> GetDetails(int id)
        {
            try
            {
                ...
                return Ok(new ResponseResult { Result = country, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
                return Ok(new ResponseResult { Result = null, IsSuccess = false, Message = ex.Message });
        ...
        [HttpPost]
        [Route("Delete")]
        public async Task<IActionResult> SoftDelete(Country country)
        {
            try
            {
                var result = await _countryService.SoftDeleteAsync(country);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> SoftDeleteById(long id)
        {
            try
            {
                var result = await _countryService.SoftDeleteByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDelete(Country country)
        {
            try
            {
                var result = await _countryService.PermanentDeleteAsync(country);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HardDeleteById(int id)
        {
            try
            {
                var result = await _countryService.PermanentDeleteByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Deleted()
        {
            try
            {
                var result = await _countryService.GetAllDeletedAsync();
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Deleted(int[] ids)
        {
            try
            {
                var res =await _countryService.MultipleRowPermanentDelete(ids);
        ...
        public async Task<IActionResult> DeletedPaginated(int page = 1, int pageSize = 10)
        {
            try
            {
                var results = await _countryService.GetDeletedPagedAsync(page, pageSize);
                return Ok(new ResponseResult { Result = results, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("Restore")]
        public async Task<IActionResult> Restore(Country country)
        {
            try
            {
                var result = await _countryService.RestoreAsync(country);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreById(long id)
        {
            try
            {
                var result = await _countryService.RestoreByIdAsync(id);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> RestoreByIds(List<long> ids)
        {
            try
            {
                var result = await _countryService.RestoreByIdsAsync(ids);
                return Ok(new ResponseResult { Result = result, IsSuccess = true, Message = "" });
            }
            catch (Exception ex)
            {
