...
namespace Desk.Services.Employees.ContactInformations
{
    ...
    {
        private readonly IEntityRepository<ContactInformation> _repository;

        public ContactInformationService(IEntityRepository<ContactInformation> repository)
        {
            _repository = repository;
        }


        public async Task<ContactInformation> AddAsync(ContactInformation model)
        {
            model.CreatedOn = DateTime.Now;
            return await _repository.AddAsync(model);
        }

        public async Task<bool> PermanentDeleteAsync(ContactInformation model)
        {
        ...
        public async Task<ContactInformation> GetByIdAsync(long id)
        {
        ...
        public async Task<bool> UpdateAsync(ContactInformation model)
        {
            return await _repository.UpdateAsync(model);
        }

        public async Task<bool> SoftDeleteAsync(ContactInformation model)
        {
        ...
        public async Task<PagedModel<ContactInformation>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<ContactInformation> pagedModel = new PagedModel<ContactInformation>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<ContactInformation>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<IEnumerable<ContactInformation>> GetAllDeletedAsync()
        {
            return await _repository.GetAllDeletedAsync();
        }

        public async Task<bool> RestoreAsync(ContactInformation model)
        {
