...
namespace Desk.Services.Employees.EmployeeExperiences
{
    ...
    {
        private readonly IEntityRepository<EmployeeExperience> _repository;

        public EmployeeExperienceService(IEntityRepository<EmployeeExperience> repository)
        {
            _repository = repository;
        }


        public async Task<EmployeeExperience> AddAsync(EmployeeExperience model)
        {
            model.CreatedOn = DateTime.Now;
            return await _repository.AddAsync(model);
        }

        public async Task<bool> PermanentDeleteAsync(EmployeeExperience model)
        {
        ...
        public async Task<IEnumerable<EmployeeExperience>> GetAllAsync()
        {
            return await _repository.GetAllAsync();
        }

        public async Task<EmployeeExperience> GetByIdAsync(long id)
        {
        ...
        public async Task<bool> UpdateAsync(EmployeeExperience model)
        {
            return await _repository.UpdateAsync(model);
        }

        public async Task<bool> SoftDeleteAsync(EmployeeExperience model)
        {
        ...
        public async Task<PagedModel<EmployeeExperience>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<EmployeeExperience> pagedModel = new PagedModel<EmployeeExperience>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<EmployeeExperience>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<IEnumerable<EmployeeExperience>> GetAllDeletedAsync()
        {
            return await _repository.GetAllDeletedAsync();
        }

        public async Task<bool> RestoreAsync(EmployeeExperience model)
        {
