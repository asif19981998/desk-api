...
namespace Desk.Services.Auth.Permissions
{
    ...
    {
        private IEntityRepository<Permission> _repository;

        public PermissionService(IEntityRepository<Permission> repository)
        {
        ...
        public async Task<bool> PermanentDeleteAsync(Permission model)
        {
        ...
        public async Task<bool> UpdateAsync(Permission model)
        {
            return await _repository.UpdateAsync(model);
        }

        public async Task<bool> SoftDeleteAsync(Permission model)
        {
        ...
        public async Task<PagedModel<Permission>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<Permission> pagedModel = new PagedModel<Permission>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<Permission>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<IEnumerable<Permission>> GetAllDeletedAsync()
        {
            return await _repository.GetAllDeletedAsync();
        }

        public async Task<bool> RestoreAsync(Permission model)
        {
