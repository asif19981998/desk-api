...
namespace Desk.Services.Auth.LoginHistories
{
    ...
    {
        private IEntityRepository<LoginHistory> _repository;

        public LoginHistoryService(IEntityRepository<LoginHistory> repository)
        {
        ...
        public async Task<bool> PermanentDeleteAsync(LoginHistory model)
        {
        ...
        public async Task<bool> UpdateAsync(LoginHistory model)
        {
            return await _repository.UpdateAsync(model);
        }

        public async Task<bool> SoftDeleteAsync(LoginHistory model)
        {
        ...
        public async Task<PagedModel<LoginHistory>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<LoginHistory> pagedModel = new PagedModel<LoginHistory>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<LoginHistory>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<IEnumerable<LoginHistory>> GetAllDeletedAsync()
        {
            return await _repository.GetAllDeletedAsync();
        }

        public async Task<bool> RestoreAsync(LoginHistory model)
        {
