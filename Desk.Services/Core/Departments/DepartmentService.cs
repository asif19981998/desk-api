...
namespace Desk.Services.Core.Departments
{
    ...
    {
        private readonly IEntityRepository<Department> _repository;

        public DepartmentService(IEntityRepository<Department> repository)
        {
        ...
        public async Task<bool> PermanentDeleteAsync(Department model)
        {
        ...
        public async Task<bool> UpdateAsync(Department model)
        {
            return await _repository.UpdateAsync(model);
        }

        public async Task<bool> SoftDeleteAsync(Department model)
        {
        ...
        public async Task<PagedModel<Department>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<Department> pagedModel = new PagedModel<Department>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<Department>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<IEnumerable<Department>> GetAllDeletedAsync()
        {
            return await _repository.GetAllDeletedAsync();
        }

        public async Task<bool> RestoreAsync(Department model)
        {
