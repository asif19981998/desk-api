...
namespace Desk.Services.Clients.Clients
{
    ...
    {
        private readonly IEntityRepository<Client> _repository;

        public ClientService(IEntityRepository<Client> repository)
        {
        ...
        public async Task<bool> PermanentDeleteAsync(Client model)
        {
        ...
        public async Task<bool> SoftDeleteAsync(Client model)
        {
        ...
        public async Task<PagedModel<Client>> GetPagedListAsync(int page, int pageSize)
        {
            ...
            PagedModel<Client> pagedModel = new PagedModel<Client>()
            {
                Models = pagedList,
        ...
        public async Task<PagedModel<Client>> GetDeletedPagedAsync(int page, int pageSize)
        {
            int resCount = TotalCount();
            var pagers = new PagedList(resCount, page, pageSize);
            int recSkip = (page - 1) * pageSize;
        ...
        public async Task<bool> RestoreAsync(Client model)
        {
